...
static char modeChar[MODE_COUNT*2][3][3][5] = 
{
	...
	{	//numbers
		{ {   DANZEFF_STOP   ,   DANZEFF_CNT, DANZEFF_SHIFT_L   , '1', '\0' }, 
      {   0              ,   DANZEFF_RAZ, DANZEFF_CAPSLOCK  , '2', '\0' }, 
      {   DANZEFF_COPY   ,   DANZEFF_TOP, DANZEFF_SHIFT_R   , '3', '\0' }},

		{ {   0              ,   DANZEFF_INS, 0                 , '4', '\0' }, 
      {   DANZEFF_DEL    ,   0          ,                ' ', '5', '\0' }, 
      {   DANZEFF_RETURN ,   0          ,  0                , '6', '\0' }},

		{ {   0              ,   DANZEFF_ACCENT,  0             , '7', '\0' }, 
      {   0              ,   0          ,  0                , '8', '\0' }, 
      {   0              ,   0          ,                '0', '9', '\0' }},
	},
