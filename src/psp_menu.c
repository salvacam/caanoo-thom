...
# define MENU_REWIND_K7    2
# define MENU_COMMAND      3

# define MENU_LOAD_SLOT    4
# define MENU_SAVE_SLOT    5
# define MENU_DEL_SLOT     6

# define MENU_HELP         7

# define MENU_LOAD_DISK0   8
# define MENU_LOAD_DISK1   9
# define MENU_LOAD_K7     10
# define MENU_LOAD_STATE  11

# define MENU_KEYBOARD    12
# define MENU_SETTINGS    13

# define MENU_SOFT_RESET  14
