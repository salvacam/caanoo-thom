...
# define KBD_MIN_AUTOFIRE_TIME   1000000
  ...
  static char loc_button_name_R[ KBD_ALL_BUTTONS ][20] =
 {
  ...
  static int loc_default_mapping[ KBD_ALL_BUTTONS ] = {
    ...
    THOMK_DOWN            , /*  KBD_DOWN       */
    THOMK_LEFT            , /*  KBD_LEFT       */
    THOMK_1               , /*  KBD_TRIANGLE   */
    THOMK_RETURN          , /*  KBD_CIRCLE     */
  ...
  static int loc_default_mapping_L[ KBD_ALL_BUTTONS ] = {
    THOMK_JOY_UP          , /*  KBD_UP         */
    THOMK_JOY_RIGHT       , /*  KBD_RIGHT      */
    THOMK_JOY_DOWN        , /*  KBD_DOWN       */
    THOMK_JOY_LEFT        , /*  KBD_LEFT       */
    ...
    THOMK_JOY_FIRE        , /*  KBD_JOY_FIRE   */
    THOMK_UP              , /*  KBD_JOY_UP     */
    THOMK_RIGHT           , /*  KBD_JOY_RIGHT  */
    THOMK_DOWN            , /*  KBD_JOY_DOWN   */
    THOMK_LEFT              /*  KBD_JOY_LEFT   */
  };
  ...
  static int loc_default_mapping_R[ KBD_ALL_BUTTONS ] = {
    ...
    THOMK_JOY_FIRE        , /*  KBD_JOY_FIRE   */
    THOMK_UP              , /*  KBD_JOY_UP     */
    THOMC_INCFIRE         , /*  KBD_JOY_RIGHT  */
    THOMK_DOWN            , /*  KBD_JOY_DOWN   */
    THOMC_DECFIRE           /*  KBD_JOY_LEFT   */
  };
...
{
  int wake = 0;
  int reverse_analog = ! THOM.psp_joystick_cursor;
