...
Author of the PSP, Gp2x, Wiz, Dingux, Caanoo port versions
...
1. INTRODUCTION
  ...
  Caanoo-THOM is a port on Caanoo of the version 1.5.5 of Thom.
...
4. LOADING TAPE FILES (K7)
  ...
  you have to put your tape file (with .zip or .k7 file extension) on your Caanoo
  memory in the 'k7' directory. 
...
5. LOADING DISK FILES (SAP)
  ...
  you have to put your disk file (with .sap file extension) on your Caanoo
...
state format is specific to Caanoo-THOM, but it might be useful to run previously
...
7. LOADING KEY MAPPING FILES
  ...
  For given games, the default keyboard mapping between Caanoo Keys and TO7-70 keys,
  is not suitable, and the game can't be played on CaanooTHOM.
